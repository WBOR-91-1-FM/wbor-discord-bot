...
export default async (ctx: Context) => {
  ...
  if (!show || show.automation) return ctx.reply('😵‍💫 There are no shows on air right now. Instead, the station is playing an [automated playlist](https://playlists.wbor.org/WBOR/).');
